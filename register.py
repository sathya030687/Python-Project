...
class register:
    def __init__(self,root):
        ...
        #==============bg image================
        self.bg=ImageTk.PhotoImage(file="/Users/Arun/Desktop/HOTEL MANAGEMENT SYSTEM/IMAGES/bimage.jpeg")
        lbl_bg=Label(self.root,image=self.bg)
        lbl_bg.place(x=0,y=0,relwidth=1,relheight=1)

        #==============left image================
        self.bg1=ImageTk.PhotoImage(file="/Users/Arun/Desktop/HOTEL MANAGEMENT SYSTEM/IMAGES/leftimage.jpeg")
        ...
        confirm_pswd.place(x=50,y=310)

        self.txt_confirm_pswd=ttk.Entry(frame,font=("times new roman",15))
        self.txt_confirm_pswd.place(x=370,y=340,width=250)

        #=============check button===============
        checkbtn=Checkbutton(frame,text="I agree to the terms & Conditions",font=("times new roman",12,"bold"),onvalue=1,offvalue=0)
        checkbtn.place(x=50,y=380)

        #==============buttons=============
        img=Image.open("/Users/Arun/Desktop/HOTEL MANAGEMENT SYSTEM/IMAGES/register.webp")
        ...
        b1.place(x=330,y=420,width=100)
